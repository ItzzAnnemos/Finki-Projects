package mk.ukim.finki.NP.lab4.ZonedDateTimeTest;
...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        return ZonedDateTime.parse("2015-06-18 23:07:25.000", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSS").withZone(ZoneId.of("Asia/Tokyo")));
    }
