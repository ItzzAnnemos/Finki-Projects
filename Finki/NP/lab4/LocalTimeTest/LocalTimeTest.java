package mk.ukim.finki.NP.lab4.LocalTimeTest;
...
public class LocalTimeTest {
    ...
    static LocalTime localTimeParse() {
         ...
         */
        return LocalTime.parse("23:07:03.100000000", DateTimeFormatter.ofPattern("HH:mm:ss.nn"));
    }
    ...
    static LocalTime localTimeMinusDuration() {
         ...
         */
        return LocalTime.from(lt).minus(Duration.ofHours(3).plusMinutes(30).plusSeconds(20).plusNanos(200000000));
    }
