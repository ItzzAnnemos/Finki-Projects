...
public class DLL<E>{
    ...
    public DLL<String> letterOrganize(DLL<String> list) {
        DLLNode<String> tmp = list.getFirst();
        while (tmp.succ != null) {
            DLLNode<String> tmp2 = tmp.succ;
        ...
        while (tmp.succ != null && tmp != null) {
            if (isVowel(tmp.element) && isVowel(tmp.succ.element)) {
